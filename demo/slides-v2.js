d3p.slides.push(function(slide){
  ...
  slide.next(); // make optional ?
});

// Slide 2
d3p.slides.push(function(){
  
  this.objects.title = d3p.theme.default.group(stage, 0, -0.1);
  d3p.theme.phd.title(this.objects.title, "d3p: D3 Present Framework");

  this.objects.subtitle = d3p.theme.default.group(stage, 0, 0.1);
