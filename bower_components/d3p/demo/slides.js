...
d3p.slides.push(function(slide){
  [
    ...
    var title = d[2] + "-" + d[3];
    slide.objects[title] = slide.make.group(slide.stage, d[0], d[1]);
...
d3p.slides.push(function(slide){
  slide.objects.bg      = slide.make.background.image(slide.stage, "assets/drawing.svg");
...
d3p.slides.push(function(slide){
  slide.objects.bg      = slide.make.background.klass(slide.stage, "color1");
...
d3p.slides.push(function(slide){
  slide.objects.bg      = slide.make.background.klass(slide.stage, "color2");
...
d3p.slides.push(function(slide){
  ...
  [
    ...
    slide.objects[b[0]] = slide.make.bubble(slide.stage, b[1], b[2], 80, "color3");
    slide.make.text(slide.objects[b[0]], b[3], "center middle white", "1.8em");
  ...
  [
    ...
    slide.objects[b[0]] = slide.make.bubble(slide.stage, b[1], b[2], 80, "color4");
    slide.make.text(slide.objects[b[0]], b[3], "center middle white", "1.8em");
...
d3p.slides.push(function(slide, next){
    slide.objects.diagram = slide.make.group(slide.stage, -1, -1);
    slide.make.svg.image(slide.objects.diagram, "assets/diagram.svg", function(layers){
...
d3p.slides.push(function(slide, next){
  ...
  slide.objects.drawing = slide.make.group(slide.stage, -1, -1);
  slide.make.svg.image(slide.objects.drawing, "assets/drawing.svg", function(layers){
